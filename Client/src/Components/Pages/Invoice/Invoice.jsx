...
function Invoice() {
    ...
    useEffect(() => {
        if (booking) {
            const {typeroom, checkin, checkout} = booking; // Destructure typeroom from booking
    ...
    if (booking) {
        totalAmount =
            parseFloat(booking.price) + 170 * (numberOfDays * booking.person); // 70 id food charge
    }
    ...
    // Conditional rendering based on loading and booking state
    if (loading) {
        return (
    ...
    // Render the invoice if booking data is found
    return (
        <div
            className="bg-gray-100 py-10 px-4 All-background-img text-black min-h-screen w-screen bg-cover bg-center flex flex-col items-center justify-start relative">
            <div
                ref={invoiceRef}
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600">Room Type: {booking.typeroom}</p>
                    </div>
                    {/* Hotel Info */}
                    <div className="text-right">
                        ...
                        <p className="text-gray-600">{booking.city}, India</p>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left table-auto border-collapse mb-6">
                            ...
                            <tr>
                                ...
                                <td className="py-3 border-b text-gray-600">
                                    ₹ {170 * (numberOfDays * booking.person)}
                                </td>
                            </tr>
                            </tbody>
                        </table>
